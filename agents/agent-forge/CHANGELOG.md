...
- Drop SWAT-era worktree paths. Setup, Write Access, and cleanup steps now use `$(repo_cache_dir)` from the git-pr skill instead of hard-coded `~/.swat/repos/emploke-marketplace/`.
